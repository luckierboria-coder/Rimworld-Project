...
namespace RimMT
{
    internal static class RimMTRuntime
    {
        ...
        internal static void Initialize()
        {
            ...
            FeatureGate.Register(JobPackageRegionwiseCache0419.FeatureId, true, "V0.4.19-JR1.1 learned one-JobPackage Regionwise BFS-order reuse: cold Vanilla learn, hot traversal skip");
            FeatureGate.Register(JobPackageRegionAllows0419.FeatureId, false, "RETIRED in JR1.1: global Region.Allows Harmony detour removed; destination permission reuse is internal to ai.jobRegionwise");
            FeatureGate.Register(AggressiveReachabilityProfiles.FeatureId, true, "V0.4.19-JR1.1 per-Pawn Region connectivity profiles with rolling mismatch safety");
        ...
        internal static void ApplySettings(RimMTSettings settings)
        {
            ...
            FeatureGate.SetEnabled(JobPackageRegionAllows0419.FeatureId, false);
