...
namespace RimMT
{
    internal static class RimMTRuntime
    {
        ...
        internal static void Initialize()
        {
            ...
            FeatureGate.Register(ParallelRegionConnectivity.FeatureId, false, "RETIRED in JS1.1/JS1.1R: near-zero-yield V0.4.15 RegionHint worker graph");
        ...
        internal static void OnMainThreadFrame()
        {
            ...
            if (!compatibilityChecked && Current.ProgramState == ProgramState.Playing && (logicalTickBoundary || mayDiagnoseProbeFailure))
            {
                ...
                // RegionHint is intentionally retired/off in JS1.1R.
