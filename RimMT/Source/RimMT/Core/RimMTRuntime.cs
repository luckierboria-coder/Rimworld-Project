...
namespace RimMT
{
    internal static class RimMTRuntime
    {
        ...
        internal static void Initialize()
        {
            ...
            FeatureGate.Register("diagnostics.jobGiverDetail", true, "V0.4.5 per-WorkGiverDef/type phase profiler for scanner hot spots");
        ...
        internal static void ApplySettings(RimMTSettings settings)
        {
            ...
            FeatureGate.SetEnabled("diagnostics.jobGiverDetail", settings.HotPathDiagnostics);
