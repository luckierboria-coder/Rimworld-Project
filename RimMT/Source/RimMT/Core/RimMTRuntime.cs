...
namespace RimMT
{
    internal static class RimMTRuntime
    {
        ...
        internal static void Initialize()
        {
            ...
            FeatureGate.Register(JobGiverSlowSearch0419S.FeatureId, true, "JS1.1S2 fanout-aware JobGiver ClosestThingReachable accelerator: >=256 ThingRequest, IList customSet >=32, or later >=16 after 24 calls / 1024 cumulative candidates");
            ...
            FeatureGate.Register(ParallelRegionConnectivity.FeatureId, false, "RETIRED in JS1.1/JS1.1R/JS1.1S/JS1.1S1/JS1.1S2: near-zero-yield V0.4.15 RegionHint worker graph");
        ...
        internal static void OnMainThreadFrame()
        {
            ...
            if (!compatibilityChecked && Current.ProgramState == ProgramState.Playing && (logicalTickBoundary || mayDiagnoseProbeFailure))
            {
                ...
                // RegionHint is intentionally retired/off in JS1.1S2.
