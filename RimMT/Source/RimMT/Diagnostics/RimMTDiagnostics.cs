    ...
    public static class RimMTDiagnostics
    {
        ...
        private static void LogReport(string kind)
        {
            ...
            sb.AppendLine("CPU scheduler view: logicalProcessors=" + RimMTRuntime.DetectedProcessorCount +
                ...
                ", workerCap=8 (V0.4.19-JS1.2 keeps the V0.4.18.2 validated worker cap; JobPackage-local pooling is main-thread synchronous and never waits on workers)");
            if (scheduler != null)
            {
            ...
            sb.AppendLine(JobPackageLocalSearch041912.Summary());
            ...
            sb.AppendLine("Reach-profile V0.4.18.2 aggressive policy retained unchanged in JS1.2: sampled positive authority ENABLED; warmup, shadow sampling, per-profile cooldown and global mismatch fuse remain active.");
