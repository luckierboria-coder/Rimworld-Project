    ...
    public static class RimMTDiagnostics
    {
        ...
        private static void LogReport(string kind)
        {
            ...
            sb.AppendLine("CPU scheduler view: logicalProcessors=" + RimMTRuntime.DetectedProcessorCount +
                ...
                ", workerCap=8 (JS1.1S2 keeps the validated JS1.1R worker cap; fanout search remains synchronous main-thread work and never waits on workers)");
            if (scheduler != null)
            {
            ...
            sb.AppendLine("Policy: JS1.1R stable baseline / JS1.1S2 fanout-aware JobGiver slow-search / static ThingRequest >=256 / IList customSet >=32 / per-package fanout 24 calls or 1024 candidate volume then >=16 / Global nearest >=32 / embedded rolling ReachProfile safety / main-thread mutable-state commit");
            ...
            sb.AppendLine("JR1/JR1.1 Regionwise experiments: RETIRED; no Regionwise or global Region.Allows accelerator is installed in JS1.1S2.");
            ...
            sb.AppendLine("ReachProfile JS1.1R/JS1.1S/JS1.1S1/JS1.1S2 policy: prediction/build behavior unchanged; rolling 8192/8 soft fuse, 3600-frame live cooldown, 256-clean forced-shadow probation, 16/256 emergency hard fuse. No extra Reachability Harmony wrapper.");
