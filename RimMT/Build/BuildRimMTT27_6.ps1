...
# ---- T27.6 production lean assertions ----
...
foreach($required in @('0.3.0','DiagnosticsV03','SlowDNJCorrelation','RecentSlowDNJ','WorkGiver_Merge.JobOnThing','ThingWithComps.CanStackWith','TryEnterNextPathCell')){
